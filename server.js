...
app.use(express.static('public')); // Предполагаем, что ваш HTML файл находится в папке public
    ...
    try {
        const response = await axios.post('https://oauth.pipedrive.com/oauth/token', null, {
            params: {
                ...
                redirect_uri: 'https://vercel.com/kates-projects-de02f52f/pipedrive-crm-integration',
                code: code
            }
        });
        ...
        res.redirect('https://your-vercel-project.vercel.app/success'); // Замените на нужный вам URL
    } catch (error) {
